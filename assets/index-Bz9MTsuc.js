import{j as e,m as C,A as U}from"./vendor-animation-IVPYdfZu.js";import{a as oa,r as h,L as sa,B as Ss,R as Ds,b as St,N as Ts,u as Is,c as $s}from"./vendor-react-DST-UJPA.js";import{f as Ls,d as i,m as jt,l as Je}from"./vendor-styles-CTnQ9FWC.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const l of c.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function a(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(o){if(o.ep)return;o.ep=!0;const c=a(o);fetch(o.href,c)}})();var so,Oa=oa;so=Oa.createRoot,Oa.hydrateRoot;const co=h.createContext({isDark:!0,toggleTheme:()=>{}}),_s=({children:t})=>{const[n,a]=h.useState(()=>{if(typeof window<"u"){const o=localStorage.getItem("theme");return o?o==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches}return!0});h.useEffect(()=>{document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem("theme",n?"dark":"light")},[n]),h.useEffect(()=>{const o=window.matchMedia("(prefers-color-scheme: dark)"),c=l=>{localStorage.getItem("theme")||a(l.matches)};return o.addEventListener("change",c),()=>o.removeEventListener("change",c)},[]);const r=()=>a(!n);return e.jsx(co.Provider,{value:{isDark:n,toggleTheme:r},children:t})},ca=()=>{const t=h.useContext(co);if(!t)throw new Error("useTheme must be used within a ThemeProvider");return t},lo=h.createContext(null),Xn="tools-auth-session",Qn="tools-webauthn-credential",As=()=>!!(window.PublicKeyCredential&&typeof window.PublicKeyCredential=="function"),Os=async()=>{if(!As())return!1;try{return await PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable()}catch{return!1}},er=()=>{const t=new Uint8Array(32);return crypto.getRandomValues(t),t},Bs=t=>{const n=new Uint8Array(t);let a="";return n.forEach(r=>a+=String.fromCharCode(r)),btoa(a)},Fs=t=>{const n=atob(t),a=new Uint8Array(n.length);for(let r=0;r<n.length;r++)a[r]=n.charCodeAt(r);return a.buffer},Ms=({children:t})=>{const[n,a]=h.useState(!1),[r,o]=h.useState(!0),[c,l]=h.useState(!1),d=h.useRef(!1),p=async()=>{try{const f={challenge:er(),rp:{name:"pranshunijhawan.dev",id:window.location.hostname},user:{id:er(),name:"auth@pranshunijhawan.dev",displayName:"pranshunijhawan.dev"},pubKeyCredParams:[{type:"public-key",alg:-7},{type:"public-key",alg:-257}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required",residentKey:"preferred"},timeout:6e4,attestation:"none"},j=await navigator.credentials.create({publicKey:f});return j?(localStorage.setItem(Qn,Bs(j.rawId)),!0):!1}catch(x){return console.error("Registration failed:",x),!1}},s=async()=>{try{const x=localStorage.getItem(Qn),j={challenge:er(),timeout:6e4,userVerification:"required",rpId:window.location.hostname,...x&&{allowCredentials:[{type:"public-key",id:Fs(x),transports:["internal"]}]}};return!!await navigator.credentials.get({publicKey:j})}catch(x){return console.error("Authentication failed:",x),!1}},u=h.useCallback(async()=>{o(!0),l(!1);const x=sessionStorage.getItem(Xn);if(x)try{const{timestamp:j}=JSON.parse(x);if(Date.now()-j<24*60*60*1e3){a(!0),o(!1);return}}catch{}if(!await Os()){a(!0),sessionStorage.setItem(Xn,JSON.stringify({timestamp:Date.now()})),o(!1);return}try{const j=localStorage.getItem(Qn);let k=!1;j?k=await s():k=await p(),k?(a(!0),sessionStorage.setItem(Xn,JSON.stringify({timestamp:Date.now()}))):l(!0)}catch{l(!0)}o(!1)},[]);h.useEffect(()=>{d.current||(d.current=!0,u())},[u]);const g=h.useCallback(()=>{u()},[u]);return e.jsx(lo.Provider,{value:{isAuthenticated:n,isLoading:r,authFailed:c,retryAuth:g},children:t})},Ps=()=>{const t=h.useContext(lo);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t},Es=Ls`
...
`,zs=i.div`
  ...
  pointer-events: none;
`,Rs=()=>{const{isDark:t}=ca();return e.jsx(Ns,{children:e.jsx(zs,{$isDark:t})})},Ws=i(C.nav)`
  position: fixed;
  top: auto;
  bottom: 24px;
  left: 0;
...
`;const Sn=[{from:0,to:4e5,rate:0},{from:4e5,to:8e5,rate:5},{from:8e5,to:12e5,rate:10},{from:12e5,to:16e5,rate:15},{from:16e5,to:2e6,rate:20},{from:2e6,to:24e5,rate:25},{from:24e5,to:null,rate:30}],Ba=75e3,mt=4,xc=12e5,hc=6e4,Fa=5e6,Ma=10,gc=12,fc=1800;function Ze(t){const n=t<0,r=Math.abs(Math.round(t)).toString();if(r.length<=3)return(n?"-":"")+r;let o="";const c=r.slice(-3),l=r.slice(0,-3);if(l.length>0){const d=[];let p=l;for(;p.length>0;)p.length>=2?(d.unshift(p.slice(-2)),p=p.slice(0,-2)):(d.unshift(p),p="");o=d.join(",")+","+c}else o=c;return(n?"-":"")+o}function E(t){return"₹"+Ze(t)}function N(t){const n=t<0,a=Math.abs(t),r=Math.round(a*100)/100,[o,c]=r.toFixed(2).split(".");return(n?"-":"")+"₹"+Ze(parseInt(o))+"."+c}function Pa(t){return t===null?"+":t===0?"0":t>=1e5?`${t/1e5}L`:Ze(t)}function mc(t){for(let n=Sn.length-1;n>=0;n--)if(t>Sn[n].from)return Sn[n].rate;return 0}function vc(t){const n=[];let a=t,r=0;for(const o of Sn){const c=o.from,d=(o.to??1/0)-c;if(a<=0){n.push({from:c,to:o.to,rate:o.rate,taxableInSlab:0,taxInSlab:0});continue}const p=Math.min(a,d),s=p*o.rate/100;n.push({from:c,to:o.to,rate:o.rate,taxableInSlab:p>0?p:0,taxInSlab:s}),r+=s,a-=p}return{slabs:n,totalTax:r}}function yc(t,n){if(n>Fa){const r=t*(1+Ma/100)*(1+mt/100),o=n-Fa,l=(t+o)*(1+mt/100),d=l<r,p=Math.min(r,l),s=p/(1+mt/100),u=s-t,g=p-s;return{surchargeApplicable:!0,surchargeRate:Ma,surchargeAmount:u,marginalReliefApplied:d,taxAfterSurcharge:s,cess:g,totalTax:p}}else{const a=t*(mt/100),r=t+a;return{surchargeApplicable:!1,surchargeRate:0,surchargeAmount:0,marginalReliefApplied:!1,taxAfterSurcharge:t,cess:a,totalTax:r}}}function Ea(t,n,a,r,o,c,l){const d=t*n/100,p=t-d;let s=0;o==="percentage"?s=t*c/100:o==="amount"&&(s=c);const u=t+s;let g=0,x=0;a&&(r==="percentage"?(g=d*gc/100,x=g):(g=fc*12,x=g));const f=t-x,j=l.map(re=>({name:re.name,amount:re.amount*12})),k=j.reduce((re,ie)=>re+ie.amount,0),S=Math.max(0,f-Ba),{slabs:I,totalTax:v}=vc(S);let w=0,_=v;S<=xc&&(w=Math.min(v,hc),_=Math.max(0,v-w));const{surchargeApplicable:A,surchargeRate:D,surchargeAmount:B,marginalReliefApplied:F,taxAfterSurcharge:y,cess:b,totalTax:T}=yc(_,S),O=g+x,P=T,$=g+T+k,m=f-g-T-k,L=m/12,M=f>0?T/f*100:0,G=mc(S);let V=0,K=s;if(s>0&&G>0){let re=s*G/100;A&&(re=re*(1+D/100)),V=re*(1+mt/100),K=s-V}const H=m+K,ue=H/12;return{baseSalary:t,basicSalary:d,hra:p,bonus:s,totalEarnings:u,employeePF:g,employerPF:x,grossSalary:f,standardDeduction:Ba,additionalDeductions:j,totalAdditionalDeductions:k,taxableIncome:S,slabs:I,taxBeforeSurcharge:v,surchargeApplicable:A,surchargeRate:D,surchargeAmount:B,marginalReliefApplied:F,taxAfterSurcharge:y,cessRate:mt,cess:b,totalTax:T,rebate87A:w,totalPFDeduction:O,totalTaxDeduction:P,totalDeductions:$,netSalaryYearly:m,netSalaryMonthly:L,effectiveTaxRate:M,bonusTaxRate:G,bonusTaxAmount:V,bonusAfterTax:K,totalIncomeYearly:H,totalIncomeMonthly:ue}}function bc(t){const n=Ea(t.baseSalary,t.basicPercentage,t.calculatePF,t.pfType,t.bonusType,t.bonusValue,t.additionalDeductions);let a=null;const r=t.hikePercentage||0;if(r>0){const o=t.baseSalary*(1+r/100);a=Ea(o,t.basicPercentage,t.calculatePF,t.pfType,t.bonusType,t.bonusValue,t.additionalDeductions)}return{...n,hikePercentage:r,postHike:a}}const la="taxCalculatorInput";function jc(t){localStorage.setItem(la,JSON.stringify(t))}function wc(){localStorage.removeItem(la)}function xo(){const t=localStorage.getItem(la);if(t)try{return JSON.parse(t)}catch{return null}return null}const kc={financialYear:"FY 2025-26"},Cc=i(C.div)`
...
`,Wt=({isOpen:t,onClose:n,selectedDate:a,onDateSelect:r,triggerRef:o})=>{const c=h.useRef(null),[l,d]=h.useState(!1),[p,s]=h.useState(!1),[u,g]=h.useState(!1),[x,f]=h.useState({top:0,left:0});h.useEffect(()=>{if(t&&(o!=null&&o.current)){const v=o.current.getBoundingClientRect(),w=280,_=320,A=8,B=window.innerHeight-v.bottom-A<_;g(B);let F;B?F=v.top-_-A:F=v.bottom+A;let y=v.right-w;y<8&&(y=8),y+w>window.innerWidth-8&&(y=window.innerWidth-w-8),F<8&&(F=8),f({top:F,left:y}),s(!0),d(!1)}},[t,o]);const j=h.useCallback(()=>{d(!0),setTimeout(()=>{s(!1),d(!1),n()},150)},[n]),k=h.useCallback(v=>{c.current&&!c.current.contains(v.target)&&j()},[j]);h.useEffect(()=>{if(t){const v=setTimeout(()=>{document.addEventListener("mousedown",k)},10);return()=>{clearTimeout(v),document.removeEventListener("mousedown",k)}}},[t,k]);const S=h.useCallback(v=>{v instanceof Date&&(r(me(v)),j())},[r,j]);if(!p)return null;const I=new Date(a+"T00:00:00");return oa.createPortal(e.jsxs("div",{"data-calendar-portal":!0,children:[e.jsx(uu,{onClick:j}),e.jsx(pu,{ref:c,$isClosing:l,$openUpward:u,$top:x.top,$left:x.left,children:e.jsx(xu,{children:e.jsx(iu,{onChange:S,value:I,calendarType:"iso8601",prev2Label:null,next2Label:null,prevLabel:"‹",nextLabel:"›",formatShortWeekday:(v,w)=>w.toLocaleDateString("en-US",{weekday:"narrow"})})})})]}),document.body)},hu=i(C.div)`
  position: relative;
  border-radius: 16px;
  overflow: visible;
  background: var(--bg-secondary);
...
`,ui=i(C.button).attrs({type:"button"})`
  width: 36px;
  height: 36px;
  display: flex;
  align-items: center;
...
`,rp=i(C.span)`
  ...
  font-weight: 600;
  color: ${({$color:t})=>t};
`,ap={hdfc:"/tools/images/HDFC.svg",icici:"/tools/images/ICICI.svg",axis:"/tools/images/Axis.svg",yes:"/tools/images/Yes.svg"},ip=t=>{const n=ap[t];return n?e.jsx("img",{src:n,alt:`${t.toUpperCase()} Bank`}):null},op=t=>new Date(t+"T00:00:00").toLocaleDateString("en-IN",{day:"numeric",month:"short"}),gi=[.25,.1,.25,1],sp=({detailedBalance:t,index:n=0,limit:a})=>{const{account:r,billDue:o,unbilled:c,totalOutstanding:l,cycleStart:d,cycleSpending:p}=t,s=a!==void 0&&a>0,u=s?Math.max(0,a-p):0,g=s?p/a*100:0,x=s&&p>a,f=x?"#ef4444":g>80?"#f59e0b":"#10b981",j=()=>o>0?"due":c>0?"unbilled":"clear",k=()=>{switch(j()){case"due":return"Bill Due";case"unbilled":return"Unbilled";case"clear":return"Clear"}};return e.jsxs(zu,{initial:{opacity:0,y:6},animate:{opacity:1,y:0},transition:{duration:.2,ease:gi,delay:n*.02},children:[e.jsxs(Ru,{children:[e.jsx(Wu,{children:ip(r.bank)}),e.jsxs(Hu,{children:[e.jsxs(Yu,{children:[r.name.replace(" Credit Card","").replace(" Bank","")," Bank"]}),e.jsxs(Vu,{children:["Cycle from ",op(d)]})]}),e.jsx(Uu,{$status:j(),children:k()})]}),e.jsxs(qu,{children:[e.jsxs(pi,{children:[e.jsx(xi,{children:"Bill Due"}),e.jsx(hi,{$color:o>0?"#ef4444":"#10b981",children:e.jsx(Fe,{value:Y(o)})})]}),e.jsxs(pi,{$align:"right",children:[e.jsx(xi,{children:"Unbilled"}),e.jsx(hi,{$color:c>0?"#f59e0b":"var(--text-tertiary)",children:e.jsx(Fe,{value:Y(c)})})]})]}),s&&e.jsxs(Gu,{children:[e.jsxs(Ku,{children:[e.jsxs(Xu,{children:[e.jsx(Qu,{children:"Virtual Limit"}),e.jsx(ep,{children:Y(a)})]}),e.jsxs(tp,{children:[e.jsx(np,{children:x?"Over By":"Available"}),e.jsx(rp,{$color:f,initial:{opacity:0},animate:{opacity:1},transition:{duration:.15},children:Y(x?l-a:u)},u)]})]}),e.jsx(Ju,{children:e.jsx(Zu,{$color:f,initial:{width:0},animate:{width:`${Math.min(g,100)}%`},transition:{duration:.4,ease:gi,delay:.1}})})]})]})},cp=h.memo(sp),lp=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"})}),dp=i(C.div)`
  display: flex;
  flex-direction: column;
  gap: 24px;
`,gr=i.div`
...
`,ox=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("polyline",{points:"6 9 12 15 18 9"})}),Ln=[.32,.72,0,1],sx={collapsed:{height:0,opacity:0,transition:{height:{duration:.3,ease:Ln},opacity:{duration:.2}}},expanded:{height:"auto",opacity:1,transition:{height:{duration:.3,ease:Ln},opacity:{duration:.25,delay:.05}}}},cx=({title:t,icon:n,accent:a,badge:r,defaultOpen:o=!0,isOpen:c,onOpenChange:l,collapseOnClickOutside:d=!1,children:p})=>{const[s,u]=h.useState(o),g=h.useRef(null),x=c!==void 0,f=x?c:s,j=Gp(a),k=()=>{const S=!f;x?l==null||l(S):u(S)};return h.useEffect(()=>{if(!d||!f)return;const S=I=>{g.current&&!g.current.contains(I.target)&&(x?l==null||l(!1):u(!1))};return document.addEventListener("mousedown",S),document.addEventListener("touchstart",S),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("touchstart",S)}},[d,f,x,l]),e.jsx(Kp,{ref:g,children:e.jsxs(Jp,{children:[e.jsxs(Zp,{type:"button",onClick:k,whileTap:{scale:.995},transition:{duration:.1},children:[e.jsxs(Xp,{children:[e.jsx(Qp,{$color:j,children:n}),e.jsx(ex,{children:t})]}),e.jsxs(tx,{children:[e.jsx(U,{mode:"wait",children:r!==void 0&&e.jsx(nx,{$color:j,initial:{opacity:0,scale:.85},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.85},transition:{duration:.2,ease:Ln},children:r},r)}),e.jsx(rx,{animate:{rotate:f?180:0},transition:{duration:.25,ease:Ln},children:e.jsx(ox,{})})]})]}),e.jsx(U,{initial:!1,children:f&&e.jsx(ax,{initial:"collapsed",animate:"expanded",exit:"collapsed",variants:sx,children:e.jsx(ix,{children:p})},"content")})]})})},lx=i.div`
  background: var(--bg-secondary);
  border: 1px solid var(--border);
  border-radius: 16px;
  overflow: hidden;
...
`,bf=i(C.div)`
  ...
  border-radius: 50%;
`,jf=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),e.jsx("polyline",{points:"7 10 12 15 17 10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),wf=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),e.jsx("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),e.jsx("polyline",{points:"21 15 16 10 5 21"})]}),kf=()=>{const{isDark:t}=ca(),[n,a]=h.useState(""),[r,o]=h.useState(64),[c,l]=h.useState("left"),[d,p]=h.useState(to[1]),[s,u]=h.useState(null),[g,x]=h.useState(!1),[f,j]=h.useState(null),[k,S]=h.useState(""),[I,v]=h.useState(""),[w,_]=h.useState(!1),[A,D]=h.useState(null),B=h.useMemo(()=>Qg(n),[n]),F=t?"#000000":"#ffffff",y=t?"#ffffff":"#000000",b=`${d.height/d.width*100}%`,T=h.useCallback(async()=>{if(!(!B||!n.trim())){_(!0),D(null),u(null);try{const m=await Zg(n.trim());j(m),S(m.title),v(m.description)}catch{D("Unable to fetch URL preview")}_(!1)}},[n,B]),O=h.useCallback(async()=>{if(!n.trim()||B){B||u(null);return}x(!0);try{const m=await qg({text:n.trim(),fontSize:r,fontFamily:Xg,textColor:y,backgroundColor:F,alignment:c,aspectRatio:d,padding:80});u(m)}catch(m){console.error("Preview generation failed:",m)}x(!1)},[n,B,r,c,d,F,y]),P=h.useCallback(async()=>{if(f){x(!0);try{const m=await Gg({metadata:{...f,title:k||f.title,description:I||f.description},aspectRatio:d,backgroundColor:F,accentColor:"#2A9D8F"});u(m)}catch(m){console.error("URL preview generation failed:",m)}x(!1)}},[f,k,I,d,F]);h.useEffect(()=>{if(B)return;const m=setTimeout(O,200);return()=>clearTimeout(m)},[O,B]),h.useEffect(()=>{B?T():(j(null),S(""),v(""),D(null))},[B,T]),h.useEffect(()=>{f&&P()},[f,k,I,d,P]);const $=()=>{if(s){const M=`pn-${new Date().toISOString().replace(/[-:]/g,"").replace("T","-").split(".")[0]}.png`;Jg(s,M)}};return e.jsxs(ef,{children:[e.jsx(tf,{children:e.jsx(nf,{children:e.jsx(rf,{$bgColor:F,$paddingBottom:b,children:e.jsxs(af,{children:[s&&e.jsx(of,{src:s,alt:"Preview"}),e.jsx(U,{children:!s&&e.jsxs(sf,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[e.jsx(wf,{}),e.jsx("span",{children:B?"Fetch URL to preview":"Type to preview"})]},"placeholder")})]})})})}),e.jsx(cf,{children:e.jsxs(lf,{children:[e.jsxs(Ft,{children:[e.jsx(Mt,{children:"Content"}),e.jsx(df,{value:n,onChange:m=>a(m.target.value),onContextMenu:m=>m.stopPropagation(),placeholder:"Type your text or paste a URL..."})]}),B?e.jsxs(e.Fragment,{children:[w&&e.jsx(Ft,{style:{alignItems:"center"},children:e.jsx(bf,{animate:{rotate:360},transition:{duration:1,repeat:1/0,ease:"linear"}})}),A&&e.jsx(yf,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},children:A}),f&&e.jsxs(ff,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsx(Mt,{children:"Edit Details"}),e.jsx(mf,{value:k,onChange:m=>S(m.target.value),placeholder:"Title"}),e.jsx(vf,{value:I,onChange:m=>v(m.target.value),placeholder:"Description"})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(Ft,{children:[e.jsx(Mt,{children:"Font Size"}),e.jsxs(uf,{children:[e.jsx(pf,{children:e.jsx(xf,{type:"range",min:"24",max:"120",value:r,onChange:m=>o(Number(m.target.value))})}),e.jsx(hf,{children:r})]})]}),e.jsxs(Ft,{children:[e.jsx(Mt,{children:"Alignment"}),e.jsx(no,{children:["left","center","right"].map(m=>e.jsx(ro,{$active:c===m,onClick:()=>l(m),children:m.charAt(0).toUpperCase()+m.slice(1)},m))})]})]}),e.jsxs(Ft,{children:[e.jsx(Mt,{children:"Format"}),e.jsx(no,{children:to.map(m=>e.jsx(ro,{$active:d.id===m.id,onClick:()=>p(m),children:m.name},m.id))})]}),e.jsxs(gf,{onClick:$,disabled:!s||g,whileTap:{scale:.98},children:[e.jsx(jf,{}),"Download Image"]})]})})]})},Cf=i(C.div)`
  min-height: 100vh;
  padding-top: 60px;
  background: var(--bg-primary);
