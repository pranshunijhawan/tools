...
`,Yt=({isOpen:t,onClose:n,selectedDate:a,onDateSelect:r,triggerRef:i})=>{const c=h.useRef(null),[l,d]=h.useState(!1),[p,s]=h.useState(!1),[u,g]=h.useState(!1),[x,f]=h.useState({top:0,left:0});h.useEffect(()=>{if(t&&(i!=null&&i.current)){const v=i.current.getBoundingClientRect(),j=280,_=320,A=8,O=window.innerHeight-v.bottom-A<_;g(O);let B;O?B=v.top-_-A:B=v.bottom+A;let y=v.right-j;y<8&&(y=8),y+j>window.innerWidth-8&&(y=window.innerWidth-j-8),B<8&&(B=8),f({top:B,left:y}),s(!0),d(!1)}},[t,i]);const w=h.useCallback(()=>{d(!0),setTimeout(()=>{s(!1),d(!1),n()},150)},[n]),k=h.useCallback(v=>{c.current&&!c.current.contains(v.target)&&w()},[w]);h.useEffect(()=>{if(t){const v=setTimeout(()=>{document.addEventListener("mousedown",k)},10);return()=>{clearTimeout(v),document.removeEventListener("mousedown",k)}}},[t,k]);const D=h.useCallback(v=>{v instanceof Date&&(r(me(v)),w())},[r,w]);if(!p)return null;const I=new Date(a+"T00:00:00");return sa.createPortal(e.jsxs("div",{"data-calendar-portal":!0,children:[e.jsx(bu,{onClick:w}),e.jsx(ju,{ref:c,$isClosing:l,$openUpward:u,$top:x.top,$left:x.left,children:e.jsx(wu,{children:e.jsx(hu,{onChange:D,value:I,calendarType:"iso8601",prev2Label:null,next2Label:null,prevLabel:"‹",nextLabel:"›",formatShortWeekday:(v,j)=>j.toLocaleDateString("en-US",{weekday:"narrow"})})})})]}),document.body)},ku=o(C.div)`
  position: relative;
  border-radius: 16px;
  overflow: visible;
  background: var(--bg-secondary);
...
`,gx=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("polyline",{points:"6 9 12 15 18 9"})}),_n=[.32,.72,0,1],fx={collapsed:{height:0,opacity:0,transition:{height:{duration:.3,ease:_n},opacity:{duration:.2}}},expanded:{height:"auto",opacity:1,transition:{height:{duration:.3,ease:_n},opacity:{duration:.25,delay:.05}}}},mx=({title:t,icon:n,accent:a,badge:r,defaultOpen:i=!0,isOpen:c,onOpenChange:l,collapseOnClickOutside:d=!1,children:p})=>{const[s,u]=h.useState(i),g=h.useRef(null),x=c!==void 0,f=x?c:s,w=rx(a),k=()=>{const D=!f;x?l==null||l(D):u(D)};return h.useEffect(()=>{if(!d||!f)return;const D=I=>{g.current&&!g.current.contains(I.target)&&(x?l==null||l(!1):u(!1))};return document.addEventListener("mousedown",D),document.addEventListener("touchstart",D),()=>{document.removeEventListener("mousedown",D),document.removeEventListener("touchstart",D)}},[d,f,x,l]),e.jsx(ax,{ref:g,children:e.jsxs(ix,{children:[e.jsxs(ox,{type:"button",onClick:k,whileTap:{scale:.995},transition:{duration:.1},children:[e.jsxs(sx,{children:[e.jsx(cx,{$color:w,children:n}),e.jsx(lx,{children:t})]}),e.jsxs(dx,{children:[e.jsx(U,{mode:"wait",children:r!==void 0&&e.jsx(ux,{$color:w,initial:{opacity:0,scale:.85},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.85},transition:{duration:.2,ease:_n},children:r},r)}),e.jsx(px,{animate:{rotate:f?180:0},transition:{duration:.25,ease:_n},children:e.jsx(gx,{})})]})]}),e.jsx(U,{initial:!1,children:f&&e.jsx(xx,{initial:"collapsed",animate:"expanded",exit:"collapsed",variants:fx,children:e.jsx(hx,{children:p})},"content")})]})})},vx=o.div`
  background: var(--bg-secondary);
  border: 1px solid var(--border);
  border-radius: 16px;
  overflow: hidden;
...
`,Vh=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),e.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),xs=[.25,.1,.25,1],Uh={hidden:{opacity:0},visible:{opacity:1},exit:{opacity:0}},qh={hidden:{opacity:0,scale:.95,y:20},visible:{opacity:1,scale:1,y:0,transition:{type:"spring",stiffness:400,damping:30}},exit:{opacity:0,scale:.95,y:20,transition:{duration:.15,ease:xs}}},Gh=({isOpen:t,onClose:n,transaction:a,categories:r,onSave:i})=>{const[c,l]=h.useState(""),[d,p]=h.useState(""),[s,u]=h.useState(""),[g,x]=h.useState(""),[f,w]=h.useState(!1),k=h.useRef(null);h.useEffect(()=>{t&&a&&(l(a.amount.toString()),p(a.date),u(a.description),x(a.categoryId||""))},[t,a]);const D=h.useMemo(()=>{const O=c.replace(/[^0-9.]/g,"").split(".");let B=O[0];const y=O[1];if(B.length>3){let b=B.substring(B.length-3),T=B.substring(0,B.length-3);T=T.replace(/\B(?=(\d{2})+(?!\d))/g,","),B=T+","+b}return y!==void 0?`${B}.${y}`:B},[c]),I=h.useCallback(S=>{const O=S.target.value.replace(/,/g,"");(O===""||/^\d*\.?\d*$/.test(O))&&l(O)},[]),v=S=>new Date(S+"T00:00:00").toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"}),j=h.useCallback(()=>{if(!a)return;const S={...a,amount:parseFloat(c)||a.amount,date:d||a.date,description:s,categoryId:g||void 0};i(S),n()},[a,c,d,s,g,i,n]),_=parseFloat(c)>0&&d,A=a&&(a.type==="credit_card_spend"||a.type==="bank_debit");return e.jsx(U,{children:t&&a&&e.jsx(_h,{variants:Uh,initial:"hidden",animate:"visible",exit:"exit",transition:{duration:.2,ease:xs},onClick:n,children:e.jsxs(Ah,{variants:qh,initial:"hidden",animate:"visible",exit:"exit",onClick:S=>S.stopPropagation(),children:[e.jsxs(Oh,{children:[e.jsx(Fh,{children:"Edit Transaction"}),e.jsx(Bh,{onClick:n,whileTap:{scale:.95},children:e.jsx(Vh,{})})]}),e.jsxs(Mh,{children:[e.jsxs(yn,{children:[e.jsx(bn,{children:"Amount"}),e.jsxs(Ph,{children:[e.jsx(Eh,{children:"₹"}),e.jsx(Nh,{type:"text",inputMode:"decimal",placeholder:"0",value:D,onChange:I})]})]}),e.jsxs(yn,{children:[e.jsx(bn,{children:"Date"}),e.jsxs(Rh,{children:[e.jsx(Wh,{children:v(d)}),e.jsx(Hh,{ref:k,onClick:()=>w(!0),whileTap:{scale:.95},children:"Change"}),e.jsx(Yt,{isOpen:f,onClose:()=>w(!1),selectedDate:d,onDateSelect:p,triggerRef:k})]})]}),e.jsxs(yn,{children:[e.jsx(bn,{children:"Description"}),e.jsx(ps,{type:"text",placeholder:"Add a note...",value:s,onChange:S=>u(S.target.value)})]}),A&&e.jsxs(yn,{children:[e.jsx(bn,{children:"Category"}),e.jsxs(zh,{value:g,onChange:S=>x(S.target.value),children:[e.jsx("option",{value:"",children:"No Category"}),[...r].sort((S,O)=>S.name.localeCompare(O.name)).map(S=>e.jsx("option",{value:S.id,children:S.name},S.id))]})]})]}),e.jsxs(Yh,{children:[e.jsx(Ti,{onClick:n,whileTap:{scale:.98},children:"Cancel"}),e.jsx(Ti,{$primary:!0,onClick:j,disabled:!_,whileTap:_?{scale:.98}:{},children:"Save"})]})]})})})},Kh=h.memo(function({balances:n,ccLimits:a,creditCardDetailedBalances:r}){return e.jsx(Pp,{balances:n,ccLimits:a,creditCardDetailedBalances:r})}),Jh=o(C.div)`
  min-height: 100vh;
  display: flex;
  flex-direction: column;
  padding-top: 0;
...
`,of=o(C.div)`
  ...
  border-radius: 50%;
`,sf=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),e.jsx("polyline",{points:"7 10 12 15 17 10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),cf=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),e.jsx("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),e.jsx("polyline",{points:"21 15 16 10 5 21"})]}),lf=()=>{const{isDark:t}=la(),[n,a]=h.useState(""),[r,i]=h.useState(64),[c,l]=h.useState("left"),[d,p]=h.useState(to[1]),[s,u]=h.useState(null),[g,x]=h.useState(!1),[f,w]=h.useState(null),[k,D]=h.useState(""),[I,v]=h.useState(""),[j,_]=h.useState(!1),[A,S]=h.useState(null),O=h.useMemo(()=>Ng(n),[n]),B=t?"#000000":"#ffffff",y=t?"#ffffff":"#000000",b=`${d.height/d.width*100}%`,T=h.useCallback(async()=>{if(!(!O||!n.trim())){_(!0),S(null),u(null);try{const m=await Pg(n.trim());w(m),D(m.title),v(m.description)}catch{S("Unable to fetch URL preview")}_(!1)}},[n,O]),F=h.useCallback(async()=>{if(!n.trim()||O){O||u(null);return}x(!0);try{const m=await Og({text:n.trim(),fontSize:r,fontFamily:Eg,textColor:y,backgroundColor:B,alignment:c,aspectRatio:d,padding:80});u(m)}catch(m){console.error("Preview generation failed:",m)}x(!1)},[n,O,r,c,d,B,y]),P=h.useCallback(async()=>{if(f){x(!0);try{const m=await Fg({metadata:{...f,title:k||f.title,description:I||f.description},aspectRatio:d,backgroundColor:B,accentColor:"#2A9D8F"});u(m)}catch(m){console.error("URL preview generation failed:",m)}x(!1)}},[f,k,I,d,B]);h.useEffect(()=>{if(O)return;const m=setTimeout(F,200);return()=>clearTimeout(m)},[F,O]),h.useEffect(()=>{O?T():(w(null),D(""),v(""),S(null))},[O,T]),h.useEffect(()=>{f&&P()},[f,k,I,d,P]);const $=()=>{if(s){const M=`pn-${new Date().toISOString().replace(/[-:]/g,"").replace("T","-").split(".")[0]}.png`;Mg(s,M)}};return e.jsxs(zg,{children:[e.jsx(Rg,{children:e.jsx(Wg,{children:e.jsx(Hg,{$bgColor:B,$paddingBottom:b,children:e.jsxs(Yg,{children:[s&&e.jsx(Vg,{src:s,alt:"Preview"}),e.jsx(U,{children:!s&&e.jsxs(Ug,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[e.jsx(cf,{}),e.jsx("span",{children:O?"Fetch URL to preview":"Type to preview"})]},"placeholder")})]})})})}),e.jsx(qg,{children:e.jsxs(Gg,{children:[e.jsxs(Pt,{children:[e.jsx(Et,{children:"Content"}),e.jsx(Kg,{value:n,onChange:m=>a(m.target.value),onContextMenu:m=>m.stopPropagation(),placeholder:"Type your text or paste a URL..."})]}),O?e.jsxs(e.Fragment,{children:[j&&e.jsx(Pt,{style:{alignItems:"center"},children:e.jsx(of,{animate:{rotate:360},transition:{duration:1,repeat:1/0,ease:"linear"}})}),A&&e.jsx(af,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},children:A}),f&&e.jsxs(tf,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsx(Et,{children:"Edit Details"}),e.jsx(nf,{value:k,onChange:m=>D(m.target.value),placeholder:"Title"}),e.jsx(rf,{value:I,onChange:m=>v(m.target.value),placeholder:"Description"})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(Pt,{children:[e.jsx(Et,{children:"Font Size"}),e.jsxs(Jg,{children:[e.jsx(Xg,{children:e.jsx(Zg,{type:"range",min:"24",max:"120",value:r,onChange:m=>i(Number(m.target.value))})}),e.jsx(Qg,{children:r})]})]}),e.jsxs(Pt,{children:[e.jsx(Et,{children:"Alignment"}),e.jsx(no,{children:["left","center","right"].map(m=>e.jsx(ro,{$active:c===m,onClick:()=>l(m),children:m.charAt(0).toUpperCase()+m.slice(1)},m))})]})]}),e.jsxs(Pt,{children:[e.jsx(Et,{children:"Format"}),e.jsx(no,{children:to.map(m=>e.jsx(ro,{$active:d.id===m.id,onClick:()=>p(m),children:m.name},m.id))})]}),e.jsxs(ef,{onClick:$,disabled:!s||g,whileTap:{scale:.98},children:[e.jsx(sf,{}),"Download Image"]})]})})]})},df=o(C.div)`
  min-height: 100vh;
  padding-top: 60px;
  background: var(--bg-primary);
