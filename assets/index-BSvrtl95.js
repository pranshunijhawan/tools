...
`,zs=o(y.button)`
  ...
  border-radius: 12px;
  cursor: pointer;
`,Bs=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M21 12V7H5a2 2 0 0 1 0-4h14v4"}),e.jsx("path",{d:"M3 5v14a2 2 0 0 0 2 2h16v-5"}),e.jsx("path",{d:"M18 12a2 2 0 0 0 0 4h4v-4Z"})]}),Rs=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"})}),Hs=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"8",width:"18",height:"4",rx:"1"}),e.jsx("path",{d:"M12 8v13"}),e.jsx("path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"}),e.jsx("path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5"})]}),Ys=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M8 12h8"})]}),Gs=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17"}),e.jsx("polyline",{points:"16 7 22 7 22 13"})]}),Vs=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),e.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),Bn=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),e.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),hn={type:"spring",stiffness:300,damping:30,mass:.8},Qs={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:hn}},Us={hidden:{height:0,opacity:0},visible:{height:"auto",opacity:1,transition:{height:{...hn},opacity:{duration:.2,delay:.1}}},exit:{height:0,opacity:0,transition:{height:{...hn},opacity:{duration:.1}}}},qs={hidden:{opacity:0,x:-20},visible:{opacity:1,x:0,transition:hn},exit:{opacity:0,x:-20,transition:{duration:.15}}};function Rn(t){const n=t.replace(/[^\d]/g,"");return n?He(parseInt(n)):""}function tn(t){return parseInt(t.replace(/,/g,""))||0}const Ks=({onCalculate:t,onReset:n,autoCalculate:a=!1})=>{const[r,i]=h.useState(""),[s,l]=h.useState("50"),[d,f]=h.useState("percentage"),[c,x]=h.useState("none"),[g,u]=h.useState(""),[m,v]=h.useState([]),[w,b]=h.useState(""),[k,$]=h.useState(!1),C=h.useRef(!1);h.useEffect(()=>{const j=Ci();j&&(i(He(j.baseSalary)),l(j.basicPercentage.toString()),f(j.pfType),x(j.bonusType),u(j.bonusValue>0?j.bonusType==="amount"?He(j.bonusValue):j.bonusValue.toString():""),v(j.additionalDeductions.map(_=>({name:_.name,amount:He(_.amount)}))),b(j.hikePercentage>0?j.hikePercentage.toString():"")),$(!0)},[]),h.useEffect(()=>{k&&a&&r&&!C.current&&(C.current=!0,setTimeout(()=>{R()},100))},[k,a,r]);const L=j=>{i(Rn(j))},O=j=>{u(Rn(j))},T=(j,_)=>{const Q=[...m];Q[j].amount=Rn(_),v(Q)},A=()=>{v([...m,{name:"",amount:""}])},W=j=>{v(m.filter((_,Q)=>Q!==j))},S=(j,_)=>{const Q=[...m];Q[j].name=_,v(Q)},R=()=>{const j={baseSalary:tn(r),basicPercentage:parseFloat(s)||50,calculatePF:!0,pfType:d,bonusType:c,bonusValue:c==="amount"?tn(g):parseFloat(g)||0,additionalDeductions:m.filter(_=>_.name&&_.amount).map(_=>({name:_.name,amount:tn(_.amount)})),hikePercentage:parseFloat(w)||0};Ms(j),t(j)},G=()=>{i(""),l("50"),f("percentage"),x("none"),u(""),v([]),b(""),Ls(),n==null||n()},te=tn(r)>0,X=r||m.length>0||c!=="none"||w;return e.jsxs(Ps,{variants:Qs,initial:"hidden",animate:"visible",children:[e.jsxs(It,{children:[e.jsxs(Mt,{children:[e.jsx(Lt,{$color:"#10b981",children:e.jsx(Bs,{})}),e.jsx(Ot,{children:"Salary Details"})]}),e.jsxs(_s,{children:[e.jsxs(pt,{children:[e.jsx(sa,{children:"Yearly CTC *"}),e.jsx(En,{children:e.jsx(qe,{type:"text",inputMode:"numeric",placeholder:"e.g., 10,00,000",value:r,onChange:j=>L(j.target.value)})})]}),e.jsxs(pt,{children:[e.jsx(sa,{children:"Basic %"}),e.jsx(Nn,{children:e.jsx(qe,{type:"number",inputMode:"numeric",placeholder:"50",value:s,onChange:j=>l(j.target.value),min:"0",max:"100"})})]})]})]}),e.jsxs(It,{children:[e.jsxs(Mt,{children:[e.jsx(Lt,{$color:"#3b82f6",children:e.jsx(Rs,{})}),e.jsx(Ot,{children:"Provident Fund"})]}),e.jsxs(la,{children:[e.jsx(Pt,{$active:d==="percentage",onClick:()=>f("percentage"),whileHover:{scale:1.02},whileTap:{scale:.98},children:"12% of Basic"}),e.jsx(Pt,{$active:d==="flat",onClick:()=>f("flat"),whileHover:{scale:1.02},whileTap:{scale:.98},children:"Flat ₹1,800/mo"})]})]}),e.jsxs(It,{children:[e.jsxs(Mt,{children:[e.jsx(Lt,{$color:"#f59e0b",children:e.jsx(Hs,{})}),e.jsx(Ot,{children:"Bonus (Optional)"})]}),e.jsxs(la,{children:[e.jsx(Pt,{$active:c==="none",onClick:()=>x("none"),whileHover:{scale:1.02},whileTap:{scale:.98},children:"None"}),e.jsx(Pt,{$active:c==="percentage",onClick:()=>x("percentage"),whileHover:{scale:1.02},whileTap:{scale:.98},children:"Percentage"}),e.jsx(Pt,{$active:c==="amount",onClick:()=>x("amount"),whileHover:{scale:1.02},whileTap:{scale:.98},children:"Amount"})]}),e.jsx(Z,{initial:!1,children:c!=="none"&&e.jsx(y.div,{initial:"hidden",animate:"visible",exit:"exit",variants:Us,style:{overflow:"hidden",marginTop:"12px"},children:e.jsxs(Wn,{children:[e.jsx(pt,{style:{flex:1},children:c==="percentage"?e.jsx(Nn,{children:e.jsx(qe,{type:"number",inputMode:"numeric",placeholder:"e.g., 10",value:g,onChange:j=>u(j.target.value)})}):e.jsx(En,{children:e.jsx(qe,{type:"text",inputMode:"numeric",placeholder:"e.g., 1,00,000",value:g,onChange:j=>O(j.target.value)})})}),e.jsx(Z,{children:g&&e.jsx(zn,{onClick:()=>u(""),initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileHover:{scale:1.1},whileTap:{scale:.9},children:e.jsx(Bn,{})})})]})},"bonus-input")})]}),e.jsxs(It,{children:[e.jsxs(Mt,{children:[e.jsx(Lt,{$color:"#ec4899",children:e.jsx(Ys,{})}),e.jsx(Ot,{children:"Monthly Deductions"})]}),e.jsxs(Fs,{children:[e.jsx(Z,{mode:"popLayout",children:m.map((j,_)=>e.jsxs(Wn,{variants:qs,initial:"hidden",animate:"visible",exit:"exit",layout:!0,children:[e.jsx(pt,{style:{flex:1},children:e.jsx(qe,{type:"text",placeholder:"Name (e.g., Cab)",value:j.name,onChange:Q=>S(_,Q.target.value)})}),e.jsx(pt,{style:{flex:1},children:e.jsx(En,{children:e.jsx(qe,{type:"text",inputMode:"numeric",placeholder:"Amount",value:j.amount,onChange:Q=>T(_,Q.target.value)})})}),e.jsx(zn,{onClick:()=>W(_),whileHover:{scale:1.1},whileTap:{scale:.9},children:e.jsx(Bn,{})})]},_))}),e.jsxs(Es,{onClick:A,whileHover:{scale:1.01},whileTap:{scale:.99},children:[e.jsx(Vs,{}),"Add Deduction"]})]})]}),e.jsxs(It,{children:[e.jsxs(Mt,{children:[e.jsx(Lt,{$color:"#8b5cf6",children:e.jsx(Gs,{})}),e.jsx(Ot,{children:"Hike / Appraisal"})]}),e.jsxs(Wn,{children:[e.jsx(pt,{style:{flex:1},children:e.jsx(Nn,{children:e.jsx(qe,{type:"number",inputMode:"numeric",placeholder:"e.g., 15",value:w,onChange:j=>b(j.target.value),min:"0",max:"200"})})}),e.jsx(Z,{children:w&&e.jsx(zn,{onClick:()=>b(""),initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileHover:{scale:1.1},whileTap:{scale:.9},children:e.jsx(Bn,{})})})]})]}),e.jsxs(Ns,{children:[e.jsx(Ws,{onClick:R,disabled:!te,whileHover:te?{scale:1.02}:{},whileTap:te?{scale:.98}:{},children:"Calculate Tax"}),e.jsx(Z,{children:X&&e.jsx(zs,{onClick:G,initial:{opacity:0,scale:.8,width:0},animate:{opacity:1,scale:1,width:"auto"},exit:{opacity:0,scale:.8,width:0},whileHover:{scale:1.02},whileTap:{scale:.98},children:"Reset"})})]})]})},Xs=o(y.div)`
  display: flex;
  flex-direction: column;
  gap: 16px;
`,Ke=o(y.div)`
...
`,ll=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M21 12V7H5a2 2 0 0 1 0-4h14v4"}),e.jsx("path",{d:"M3 5v14a2 2 0 0 0 2 2h16v-5"}),e.jsx("path",{d:"M18 12a2 2 0 0 0 0 4h4v-4Z"})]}),cl=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"}),e.jsx("path",{d:"M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"}),e.jsx("path",{d:"M12 17.5v-11"})]}),dl=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M3 9h18"}),e.jsx("path",{d:"M9 21V9"})]}),pl=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"8",width:"18",height:"4",rx:"1"}),e.jsx("path",{d:"M12 8v13"}),e.jsx("path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"}),e.jsx("path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5"})]}),xa=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17"}),e.jsx("polyline",{points:"16 7 22 7 22 13"})]}),xl=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2",ry:"2"}),e.jsx("line",{x1:"16",y1:"2",x2:"16",y2:"6"}),e.jsx("line",{x1:"8",y1:"2",x2:"8",y2:"6"}),e.jsx("line",{x1:"3",y1:"10",x2:"21",y2:"10"})]}),ul={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.08,delayChildren:.1}}},nt={hidden:{opacity:0,y:15},visible:{opacity:1,y:0,transition:{type:"spring",stiffness:300,damping:30}}},hl=({breakdown:t})=>{const[n,a]=h.useState("monthly"),r=n==="monthly"?1/12:1,i=u=>u===0?"#10b981":u<=10?"#3BB4B1":u<=20?"#4361A5":u<=25?"#6B8DD6":"#7BA7D9",s=Math.max(...t.slabs.map(u=>u.taxInSlab),1),d=(()=>{const u=n==="monthly"?.08333333333333333:1,m=[{label:"In-Hand",value:t.netSalaryYearly*u,color:"#10b981"},{label:"Tax",value:t.totalTax*u,color:"#4361A5"},{label:"PF",value:t.employeePF*u,color:"#3BB4B1"}];return t.totalAdditionalDeductions>0&&m.push({label:"Other",value:t.totalAdditionalDeductions*u,color:"#7BA7D9"}),m})(),f=d.reduce((u,m)=>u+m.value,0),c=[];t.surchargeApplicable&&c.push(`<strong>${t.surchargeRate}% surcharge</strong> applied (income > ₹50L)${t.marginalReliefApplied?" with marginal relief":""}`),t.rebate87A>0&&c.push(`<strong>Section 87A rebate</strong> of ${I(t.rebate87A)} applied`),t.effectiveTaxRate>0&&c.push(`Effective tax rate: <strong>${t.effectiveTaxRate.toFixed(1)}%</strong> of gross salary`);const x=!!t.postHike,g=t.bonus>0;return e.jsxs(Xs,{variants:ul,initial:"hidden",animate:"visible",children:[x&&e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#3b82f6",children:e.jsx(xa,{})}),e.jsx(et,{children:"Base Salary (CTC)"})]}),e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]})]}),e.jsx(tt,{children:e.jsxs(Ft,{children:[e.jsxs(Se,{children:[e.jsx(Ce,{children:"Current"}),e.jsx(Te,{children:I(t.baseSalary)})]}),e.jsxs(Se,{$highlight:!0,children:[e.jsx(Ce,{children:"After Hike"}),e.jsx(Te,{children:I(t.postHike.baseSalary)}),e.jsxs(Et,{children:["+",I(t.postHike.baseSalary-t.baseSalary)]})]})]})})]}),e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#10b981",children:e.jsx(ll,{})}),e.jsx(et,{children:"In-Hand Salary"})]}),e.jsxs(_t,{children:[x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]}),e.jsxs(Gn,{children:[e.jsx(xt,{$active:n==="monthly",onClick:()=>a("monthly"),children:"Monthly"}),e.jsx(xt,{$active:n==="yearly",onClick:()=>a("yearly"),children:"Yearly"})]})]})]}),e.jsx(tt,{children:x?e.jsxs(Ft,{children:[e.jsxs(Se,{children:[e.jsx(Ce,{children:"Current"}),e.jsx(Te,{children:P(n==="monthly"?t.netSalaryMonthly:t.netSalaryYearly)})]}),e.jsxs(Se,{$highlight:!0,children:[e.jsxs(Ce,{children:["After ",t.hikePercentage,"% Hike"]}),e.jsx(Te,{children:P(n==="monthly"?t.postHike.netSalaryMonthly:t.postHike.netSalaryYearly)}),e.jsxs(Et,{children:["+",I(n==="monthly"?t.postHike.netSalaryMonthly-t.netSalaryMonthly:t.postHike.netSalaryYearly-t.netSalaryYearly)]})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Hn,{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},transition:{type:"spring",stiffness:300,damping:25},children:P(n==="monthly"?t.netSalaryMonthly:t.netSalaryYearly)},n),e.jsxs(Yn,{children:[n==="monthly"?"Per month":"Per year"," (after all deductions)"]})]})})]}),g&&e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#f59e0b",children:e.jsx(pl,{})}),e.jsx(et,{children:"Bonus"})]}),x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]})]}),e.jsxs(tt,{children:[x?e.jsxs(e.Fragment,{children:[e.jsxs(Ft,{children:[e.jsxs(Se,{children:[e.jsx(Ce,{children:"Current Gross"}),e.jsx(Te,{children:I(t.bonus)})]}),e.jsxs(Se,{$highlight:!0,children:[e.jsx(Ce,{children:"After Hike Gross"}),e.jsx(Te,{children:I(t.postHike.bonus)}),e.jsxs(Et,{children:["+",I(t.postHike.bonus-t.bonus)]})]})]}),e.jsx(Me,{}),e.jsxs(Ft,{children:[e.jsxs(Se,{children:[e.jsx(Ce,{children:"Current In-Hand"}),e.jsx(Te,{children:P(t.bonusAfterTax)})]}),e.jsxs(Se,{$highlight:!0,children:[e.jsx(Ce,{children:"After Hike In-Hand"}),e.jsx(Te,{children:P(t.postHike.bonusAfterTax)}),e.jsxs(Et,{children:["+",I(t.postHike.bonusAfterTax-t.bonusAfterTax)]})]})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Hn,{$gradient:"linear-gradient(135deg, #f59e0b, #ef4444)",children:I(t.bonus)}),e.jsx(Yn,{children:"Gross Bonus (before tax)"}),e.jsx(Me,{}),e.jsxs(re,{children:[e.jsxs(ae,{children:["Tax Deducted (",t.bonusTaxRate,"%",t.surchargeApplicable?" + surcharge":""," + cess)"]}),e.jsxs(N,{$negative:!0,children:["-",P(t.bonusTaxAmount)]})]}),e.jsxs(re,{children:[e.jsx(ae,{$bold:!0,children:"In-Hand Bonus"}),e.jsx(N,{$highlight:!0,children:P(t.bonusAfterTax)})]})]}),e.jsx(Me,{}),e.jsx(da,{style:{borderLeftColor:"#f59e0b"},children:e.jsxs(pa,{children:["Bonus is taxed at your ",e.jsxs("strong",{children:["highest slab rate (",t.bonusTaxRate,"%)"]}),t.surchargeApplicable?` + ${t.surchargeRate}% surcharge`:""," + ",t.cessRate,"% cess"]})})]})]}),g&&e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#8b5cf6",children:e.jsx(xa,{})}),e.jsx(et,{children:"Total Combined Income"})]}),e.jsxs(_t,{children:[x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]}),e.jsx($e,{children:"Yearly"})]})]}),e.jsxs(tt,{children:[x?e.jsxs(Ft,{children:[e.jsxs(Se,{children:[e.jsx(Ce,{children:"Current Total"}),e.jsx(Te,{children:P(t.totalIncomeYearly)})]}),e.jsxs(Se,{$highlight:!0,children:[e.jsx(Ce,{children:"After Hike Total"}),e.jsx(Te,{children:P(t.postHike.totalIncomeYearly)}),e.jsxs(Et,{children:["+",I(t.postHike.totalIncomeYearly-t.totalIncomeYearly)]})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Hn,{$gradient:"linear-gradient(135deg, #8b5cf6, #3b82f6)",children:P(t.totalIncomeYearly)}),e.jsx(Yn,{children:"Base salary + Bonus (after tax)"})]}),e.jsx(Me,{}),e.jsxs(re,{children:[e.jsx(ae,{children:"Base In-Hand (Yearly)"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:P(t.netSalaryYearly)}),e.jsxs(he,{$positive:!0,children:["→ ",P(t.postHike.netSalaryYearly)]})]}):e.jsx(N,{children:P(t.netSalaryYearly)})]}),e.jsxs(re,{children:[e.jsx(ae,{children:"Bonus In-Hand"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:P(t.bonusAfterTax)}),e.jsxs(he,{$positive:!0,children:["→ ",P(t.postHike.bonusAfterTax)]})]}):e.jsx(N,{children:P(t.bonusAfterTax)})]}),e.jsxs(re,{children:[e.jsx(ae,{$bold:!0,children:"Total Combined"}),x?e.jsxs(ue,{children:[e.jsx(N,{$highlight:!0,children:P(t.totalIncomeYearly)}),e.jsxs(he,{$positive:!0,children:["→ ",P(t.postHike.totalIncomeYearly)]})]}):e.jsx(N,{$highlight:!0,children:P(t.totalIncomeYearly)})]})]})]}),e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#ec4899",children:e.jsx(dl,{})}),e.jsx(et,{children:"Summary"})]}),e.jsxs(_t,{children:[x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]}),e.jsxs(Gn,{children:[e.jsx(xt,{$active:n==="monthly",onClick:()=>a("monthly"),children:"Monthly"}),e.jsx(xt,{$active:n==="yearly",onClick:()=>a("yearly"),children:"Yearly"})]})]})]}),e.jsxs(tt,{children:[e.jsxs(Js,{children:[e.jsxs(ut,{children:[e.jsx(ht,{children:"Gross Salary"}),e.jsx(ft,{children:I(t.grossSalary*r)}),x&&e.jsxs(gt,{$positive:!0,children:["→ ",I(t.postHike.grossSalary*r)]})]}),e.jsxs(ut,{children:[e.jsx(ht,{children:"Total Tax"}),e.jsx(ft,{children:P(t.totalTax*r)}),x&&e.jsxs(gt,{children:["→ ",P(t.postHike.totalTax*r)]})]}),e.jsxs(ut,{children:[e.jsx(ht,{children:"Employee PF"}),e.jsx(ft,{children:I(t.employeePF*r)}),x&&e.jsxs(gt,{$positive:!0,children:["→ ",I(t.postHike.employeePF*r)]})]}),e.jsxs(ut,{children:[e.jsx(ht,{children:"Employer PF"}),e.jsx(ft,{children:I(t.employerPF*r)}),x&&e.jsxs(gt,{$positive:!0,children:["→ ",I(t.postHike.employerPF*r)]})]}),e.jsxs(ut,{children:[e.jsx(ht,{children:"Total PF"}),e.jsx(ft,{children:I((t.employeePF+t.employerPF)*r)}),x&&e.jsxs(gt,{$positive:!0,children:["→ ",I((t.postHike.employeePF+t.postHike.employerPF)*r)]})]}),e.jsxs(ut,{children:[e.jsx(ht,{children:"Eff. Tax Rate"}),e.jsxs(ft,{children:[t.effectiveTaxRate.toFixed(2),"%"]}),x&&e.jsxs(gt,{children:["→ ",t.postHike.effectiveTaxRate.toFixed(2),"%"]})]})]}),e.jsx(Me,{}),e.jsxs("div",{style:{fontSize:12,fontWeight:500,color:"var(--text-secondary)",marginBottom:8},children:["Salary Distribution (",n==="monthly"?"Monthly":"Yearly",")"]}),e.jsx(tl,{children:d.map((u,m)=>e.jsx(nl,{$color:u.color,initial:{width:0},animate:{width:`${u.value/f*100}%`},transition:{delay:.3+m*.1,duration:.5}},m))}),e.jsx(rl,{children:d.map((u,m)=>e.jsxs(al,{children:[e.jsx(il,{$color:u.color}),e.jsx(ol,{children:u.label}),e.jsx(sl,{children:I(u.value)})]},m))}),c.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(Me,{}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:c.map((u,m)=>e.jsx(da,{children:e.jsx(pa,{dangerouslySetInnerHTML:{__html:u}})},m))})]})]})]}),e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#10b981",children:e.jsx(xl,{})}),e.jsx(et,{children:"Breakdown"})]}),e.jsxs(_t,{children:[x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]}),e.jsxs(Gn,{children:[e.jsx(xt,{$active:n==="monthly",onClick:()=>a("monthly"),children:"Monthly"}),e.jsx(xt,{$active:n==="yearly",onClick:()=>a("yearly"),children:"Yearly"})]})]})]}),e.jsxs(tt,{children:[e.jsxs(re,{children:[e.jsx(ae,{children:"Base Salary (CTC)"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:I(t.baseSalary*r)}),e.jsxs(he,{$positive:!0,children:["→ ",I(t.postHike.baseSalary*r)]})]}):e.jsx(N,{children:I(t.baseSalary*r)})]}),t.employerPF>0&&e.jsxs(re,{children:[e.jsx(ae,{children:"Less: Employer PF"}),x?e.jsxs(ue,{children:[e.jsxs(N,{$negative:!0,children:["-",I(t.employerPF*r)]}),e.jsxs(he,{children:["→ -",I(t.postHike.employerPF*r)]})]}):e.jsxs(N,{$negative:!0,children:["-",I(t.employerPF*r)]})]}),e.jsxs(re,{children:[e.jsx(ae,{$bold:!0,children:"Gross Salary"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:I(t.grossSalary*r)}),e.jsxs(he,{$positive:!0,children:["→ ",I(t.postHike.grossSalary*r)]})]}):e.jsx(N,{children:I(t.grossSalary*r)})]}),e.jsxs(re,{children:[e.jsx(ae,{children:"Less: Standard Deduction"}),e.jsxs(N,{$negative:!0,children:["-",I(t.standardDeduction*r)]})]}),e.jsxs(re,{children:[e.jsx(ae,{$bold:!0,children:"Taxable Income"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:I(t.taxableIncome*r)}),e.jsxs(he,{$positive:!0,children:["→ ",I(t.postHike.taxableIncome*r)]})]}):e.jsx(N,{children:I(t.taxableIncome*r)})]}),e.jsx(Me,{}),e.jsxs(re,{children:[e.jsx(ae,{children:"Less: Income Tax"}),x?e.jsxs(ue,{children:[e.jsxs(N,{$negative:!0,children:["-",P(t.totalTax*r)]}),e.jsxs(he,{children:["→ -",P(t.postHike.totalTax*r)]})]}):e.jsxs(N,{$negative:!0,children:["-",P(t.totalTax*r)]})]}),t.employeePF>0&&e.jsxs(re,{children:[e.jsx(ae,{children:"Less: Employee PF"}),x?e.jsxs(ue,{children:[e.jsxs(N,{$negative:!0,children:["-",I(t.employeePF*r)]}),e.jsxs(he,{children:["→ -",I(t.postHike.employeePF*r)]})]}):e.jsxs(N,{$negative:!0,children:["-",I(t.employeePF*r)]})]}),t.additionalDeductions.map((u,m)=>e.jsxs(re,{children:[e.jsxs(ae,{children:["Less: ",u.name]}),e.jsxs(N,{$negative:!0,children:["-",I(u.amount*r)]})]},m)),e.jsx(Me,{}),e.jsxs(re,{children:[e.jsxs(ae,{$bold:!0,children:["Net In-Hand (",n==="monthly"?"Monthly":"Yearly",")"]}),x?e.jsxs(ue,{children:[e.jsx(N,{$highlight:!0,children:P(n==="monthly"?t.netSalaryMonthly:t.netSalaryYearly)}),e.jsxs(he,{$positive:!0,children:["→ ",P(n==="monthly"?t.postHike.netSalaryMonthly:t.postHike.netSalaryYearly)]})]}):e.jsx(N,{$highlight:!0,children:P(n==="monthly"?t.netSalaryMonthly:t.netSalaryYearly)})]})]})]}),e.jsxs(Ke,{variants:nt,children:[e.jsxs(Xe,{children:[e.jsxs(Je,{children:[e.jsx(Ze,{$color:"#3b82f6",children:e.jsx(cl,{})}),e.jsx(et,{children:"Tax Slabs"})]}),e.jsxs(_t,{children:[e.jsx($e,{children:Os.financialYear}),x&&e.jsxs($e,{$color:"#10b981",children:["+",t.hikePercentage,"% Hike"]})]})]}),e.jsxs(tt,{children:[e.jsxs(Zs,{children:[e.jsxs(ca,{$header:!0,children:[e.jsx(Ne,{children:"Slab"}),e.jsx(Ne,{$align:"center",children:"Rate"}),e.jsx(Ne,{$align:"right",children:"Amount"}),e.jsx(Ne,{$align:"right",children:"Tax"})]}),e.jsx(Z,{children:t.slabs.map((u,m)=>e.jsxs(ca,{initial:{opacity:0,x:-10},animate:{opacity:1,x:0},transition:{delay:m*.03},children:[e.jsxs(Ne,{children:[ia(u.from)," - ",ia(u.to),u.taxableInSlab>0&&e.jsx(el,{$color:i(u.rate),initial:{width:0},animate:{width:`${Math.max(u.taxInSlab/s*100,8)}%`},transition:{delay:.2+m*.03,duration:.4}})]}),e.jsxs(Ne,{$align:"center",$highlight:u.rate===0,children:[u.rate,"%"]}),e.jsx(Ne,{$align:"right",$muted:u.taxableInSlab===0,children:u.taxableInSlab>0?I(u.taxableInSlab):"-"}),e.jsx(Ne,{$align:"right",$muted:u.taxInSlab===0,children:u.taxInSlab>0?I(u.taxInSlab):"-"})]},m))})]}),e.jsx(Me,{}),e.jsxs(re,{children:[e.jsx(ae,{children:"Tax Before Surcharge"}),x?e.jsxs(ue,{children:[e.jsx(N,{children:P(t.taxBeforeSurcharge)}),e.jsxs(he,{children:["→ ",P(t.postHike.taxBeforeSurcharge)]})]}):e.jsx(N,{children:P(t.taxBeforeSurcharge)})]}),t.rebate87A>0&&e.jsxs(re,{children:[e.jsx(ae,{children:"Section 87A Rebate"}),e.jsxs(N,{$negative:!0,children:["-",I(t.rebate87A)]})]}),t.surchargeApplicable&&e.jsxs(re,{children:[e.jsxs(ae,{children:["Surcharge (",t.surchargeRate,"%)",t.marginalReliefApplied&&e.jsx($e,{$color:"#f59e0b",children:"Marginal Relief"})]}),x&&t.postHike.surchargeApplicable?e.jsxs(ue,{children:[e.jsx(N,{children:P(t.surchargeAmount)}),e.jsxs(he,{children:["→ ",P(t.postHike.surchargeAmount)]})]}):e.jsx(N,{children:P(t.surchargeAmount)})]}),e.jsxs(re,{children:[e.jsxs(ae,{children:["Cess (",t.cessRate,"%)"]}),x?e.jsxs(ue,{children:[e.jsx(N,{children:P(t.cess)}),e.jsxs(he,{children:["→ ",P(t.postHike.cess)]})]}):e.jsx(N,{children:P(t.cess)})]}),e.jsxs(re,{children:[e.jsx(ae,{$bold:!0,children:"Total Tax"}),x?e.jsxs(ue,{children:[e.jsx(N,{$highlight:!0,children:P(t.totalTax)}),e.jsxs(he,{children:["→ ",P(t.postHike.totalTax)]})]}):e.jsx(N,{$highlight:!0,children:P(t.totalTax)})]})]})]})]})},fl=o(y.div)`
  min-height: 100vh;
...
`,Gd=[{value:"bank_debit",label:"Bank Debit"},{value:"bank_credit",label:"Bank Credit"},{value:"investment_credit",label:"Investment Deposit"},{value:"investment_debit",label:"Investment Withdrawal"}];function Vd(t){const n=t.replace(/[^\d]/g,"");return n?He(parseInt(n)):""}function Qd(t){return parseInt(t.replace(/,/g,""))||0}const Ud=({onAddTransaction:t})=>{const[n,a]=h.useState("bank_debit"),[r,i]=h.useState(Ye[0].id),[s,l]=h.useState(""),[d,f]=h.useState(""),[c,x]=h.useState(""),[g,u]=h.useState(at(new Date)),[m,v]=h.useState(!1),w=h.useRef(null),b=n==="investment_credit"||n==="investment_debit",k=h.useMemo(()=>b?ir():ze(),[b]),$=h.useMemo(()=>n==="investment_credit"||n==="investment_debit"?ze():[],[n]),C=b&&r!=="pf",L=h.useCallback(S=>{a(S);const R=S==="investment_credit"||S==="investment_debit",G=R?ir():ze(),ee=G.length>0?G[0].id:"";i(ee);const te=ze();R&&ee!=="pf"&&te.length>0?l(te[0].id):l("")},[]),O=Qd(d),T=r&&O>0&&c.trim(),A=h.useCallback(()=>{if(!T)return;const S=Dl(n,r,O,c.trim(),g,C?s:void 0);t(S),f(""),x("")},[n,r,O,c,g,s,C,T,t]),W=S=>new Date(S+"T00:00:00").toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"});return e.jsxs(Rd,{children:[e.jsxs(mt,{children:[e.jsx(yt,{children:"Type"}),e.jsx(Xn,{value:n,onChange:S=>L(S.target.value),children:Gd.map(S=>e.jsx("option",{value:S.value,children:S.label},S.value))})]}),e.jsxs(mt,{children:[e.jsx(yt,{children:b?"Investment Account":"Bank Account"}),e.jsx(Xn,{value:r,onChange:S=>{const R=S.target.value;if(i(R),R==="pf")l("");else if(b&&!s){const G=ze();G.length>0&&l(G[0].id)}},children:k.map(S=>e.jsx("option",{value:S.id,children:S.name},S.id))})]}),C&&e.jsxs(mt,{children:[e.jsx(yt,{children:n==="investment_credit"?"From Bank":"To Bank"}),e.jsx(Xn,{value:s,onChange:S=>l(S.target.value),children:$.map(S=>e.jsx("option",{value:S.id,children:S.name},S.id))})]}),e.jsxs(mt,{children:[e.jsx(yt,{children:"Amount"}),e.jsx(Ia,{type:"text",inputMode:"numeric",placeholder:"0",value:d,onChange:S=>f(Vd(S.target.value))})]}),e.jsxs(mt,{children:[e.jsx(yt,{children:"Description"}),e.jsx(Ia,{type:"text",placeholder:"What's this for?",value:c,onChange:S=>x(S.target.value),onKeyDown:S=>S.key==="Enter"&&A()})]}),e.jsxs(mt,{children:[e.jsx(yt,{children:"Date"}),e.jsx(Hd,{ref:w,type:"button",onClick:()=>v(!0),children:W(g)}),e.jsx(Yt,{isOpen:m,onClose:()=>v(!1),selectedDate:g,onDateSelect:S=>{u(S),v(!1)},triggerRef:w})]}),e.jsx(Yd,{disabled:!T,onClick:A,whileTap:{scale:.98},children:"Add Transaction"})]})},qd=h.memo(Ud),to=[.25,.1,.25,1],no={hidden:{opacity:0},visible:{opacity:1},exit:{opacity:0}},ro={hidden:{opacity:0,scale:.95,y:10},visible:{opacity:1,scale:1,y:0,transition:{type:"spring",stiffness:400,damping:30}},exit:{opacity:0,scale:.95,y:10,transition:{duration:.15,ease:to}}};function ao(t){h.useEffect(()=>{if(t)return document.documentElement.style.overflow="hidden",document.body.style.overflow="hidden",document.body.style.touchAction="none",()=>{document.documentElement.style.overflow="",document.body.style.overflow="",document.body.style.touchAction=""}},[t])}const io=o(y.div)`
  position: fixed;
  inset: 0;
...
`,s0=o.span`
  display: inline-block;
`,l0=[.25,.1,.25,1],c0=({value:t,className:n})=>{const a=h.useMemo(()=>t.split("").map((r,i)=>({char:r,key:`${i}-${r}`,isDigit:/[0-9]/.test(r)})),[t]);return e.jsx(a0,{className:n,children:a.map(({char:r,key:i,isDigit:s},l)=>s?e.jsx(i0,{children:e.jsx(Z,{mode:"popLayout",initial:!1,children:e.jsx(o0,{initial:{y:"100%",opacity:0},animate:{y:0,opacity:1},exit:{y:"-100%",opacity:0},transition:{duration:.25,ease:l0},children:r},i)})},`wrapper-${l}`):e.jsx(s0,{children:r},`static-${l}`))})},Jn=h.memo(c0);o.h1`
...
`,px=o(y.div)`
  ...
  border-radius: 50%;
`,xx=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),e.jsx("polyline",{points:"7 10 12 15 17 10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),ux=()=>e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),e.jsx("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),e.jsx("polyline",{points:"21 15 16 10 5 21"})]}),hx=()=>{const{isDark:t}=$r(),[n,a]=h.useState(""),[r,i]=h.useState(64),[s,l]=h.useState("left"),[d,f]=h.useState(ti[1]),[c,x]=h.useState(null),[g,u]=h.useState(!1),[m,v]=h.useState(null),[w,b]=h.useState(""),[k,$]=h.useState(""),[C,L]=h.useState(!1),[O,T]=h.useState(null),A=h.useMemo(()=>Gp(n),[n]),W=t?"#000000":"#ffffff",S=t?"#ffffff":"#000000",R=`${d.height/d.width*100}%`,G=h.useCallback(async()=>{if(!(!A||!n.trim())){L(!0),T(null),x(null);try{const j=await Hp(n.trim());v(j),b(j.title),$(j.description)}catch{T("Unable to fetch URL preview")}L(!1)}},[n,A]),ee=h.useCallback(async()=>{if(!n.trim()||A){A||x(null);return}u(!0);try{const j=await Wp({text:n.trim(),fontSize:r,fontFamily:Yp,textColor:S,backgroundColor:W,alignment:s,aspectRatio:d,padding:80});x(j)}catch(j){console.error("Preview generation failed:",j)}u(!1)},[n,A,r,s,d,W,S]),te=h.useCallback(async()=>{if(m){u(!0);try{const j=await zp({metadata:{...m,title:w||m.title,description:k||m.description},aspectRatio:d,backgroundColor:W,accentColor:"#2A9D8F"});x(j)}catch(j){console.error("URL preview generation failed:",j)}u(!1)}},[m,w,k,d,W]);h.useEffect(()=>{if(A)return;const j=setTimeout(ee,200);return()=>clearTimeout(j)},[ee,A]),h.useEffect(()=>{A?G():(v(null),b(""),$(""),T(null))},[A,G]),h.useEffect(()=>{m&&te()},[m,w,k,d,te]);const X=()=>{if(c){const Q=`pn-${new Date().toISOString().replace(/[-:]/g,"").replace("T","-").split(".")[0]}.png`;Rp(c,Q)}};return e.jsxs(Vp,{children:[e.jsx(Qp,{children:e.jsx(Up,{children:e.jsx(qp,{$bgColor:W,$paddingBottom:R,children:e.jsxs(Kp,{children:[c&&e.jsx(Xp,{src:c,alt:"Preview"}),e.jsx(Z,{children:!c&&e.jsxs(Jp,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[e.jsx(ux,{}),e.jsx("span",{children:A?"Fetch URL to preview":"Type to preview"})]},"placeholder")})]})})})}),e.jsx(Zp,{children:e.jsxs(ex,{children:[e.jsxs(Nt,{children:[e.jsx(Wt,{children:"Content"}),e.jsx(tx,{value:n,onChange:j=>a(j.target.value),onContextMenu:j=>j.stopPropagation(),placeholder:"Type your text or paste a URL..."})]}),A?e.jsxs(e.Fragment,{children:[C&&e.jsx(Nt,{style:{alignItems:"center"},children:e.jsx(px,{animate:{rotate:360},transition:{duration:1,repeat:1/0,ease:"linear"}})}),O&&e.jsx(dx,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},children:O}),m&&e.jsxs(sx,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsx(Wt,{children:"Edit Details"}),e.jsx(lx,{value:w,onChange:j=>b(j.target.value),placeholder:"Title"}),e.jsx(cx,{value:k,onChange:j=>$(j.target.value),placeholder:"Description"})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(Nt,{children:[e.jsx(Wt,{children:"Font Size"}),e.jsxs(nx,{children:[e.jsx(rx,{children:e.jsx(ax,{type:"range",min:"24",max:"120",value:r,onChange:j=>i(Number(j.target.value))})}),e.jsx(ix,{children:r})]})]}),e.jsxs(Nt,{children:[e.jsx(Wt,{children:"Alignment"}),e.jsx(ni,{children:["left","center","right"].map(j=>e.jsx(ri,{$active:s===j,onClick:()=>l(j),children:j.charAt(0).toUpperCase()+j.slice(1)},j))})]})]}),e.jsxs(Nt,{children:[e.jsx(Wt,{children:"Format"}),e.jsx(ni,{children:ti.map(j=>e.jsx(ri,{$active:d.id===j.id,onClick:()=>f(j),children:j.name},j.id))})]}),e.jsxs(ox,{onClick:X,disabled:!c||g,whileTap:{scale:.98},children:[e.jsx(xx,{}),"Download Image"]})]})})]})},fx=o(y.div)`
  min-height: 100vh;
  padding-top: 60px;
  background: var(--bg-primary);
...
`,Le=p.accent,fe=p.warmGold,K=p.textMuted,ce=p.blush,Gx=({storyDone:t})=>e.jsx(Ex,{style:{opacity:t?0:.55,transition:"opacity 1.5s ease"},children:e.jsxs(Nx,{viewBox:"0 0 520 240",fill:"none",children:[e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"sky",x1:"0",y1:"0",x2:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:p.softPink,stopOpacity:"0.15"}),e.jsx("stop",{offset:"100%",stopColor:p.bgAlt,stopOpacity:"0.05"})]}),e.jsxs("linearGradient",{id:"platform",x1:"0",y1:"0",x2:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:K,stopOpacity:"0.6"}),e.jsx("stop",{offset:"100%",stopColor:K,stopOpacity:"0.35"})]}),e.jsxs("linearGradient",{id:"canopy",x1:"0",y1:"0",x2:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:K,stopOpacity:"0.5"}),e.jsx("stop",{offset:"100%",stopColor:ce,stopOpacity:"0.2"})]}),e.jsxs("linearGradient",{id:"pillar",x1:"0",y1:"0",x2:"1",y2:"0",children:[e.jsx("stop",{offset:"0%",stopColor:K,stopOpacity:"0.5"}),e.jsx("stop",{offset:"50%",stopColor:K,stopOpacity:"0.35"}),e.jsx("stop",{offset:"100%",stopColor:K,stopOpacity:"0.5"})]}),e.jsxs("linearGradient",{id:"trainBody",x1:"0",y1:"0",x2:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:fe,stopOpacity:"0.7"}),e.jsx("stop",{offset:"100%",stopColor:p.gold,stopOpacity:"0.4"})]}),e.jsxs("filter",{id:"glow",children:[e.jsx("feGaussianBlur",{stdDeviation:"3",result:"blur"}),e.jsxs("feMerge",{children:[e.jsx("feMergeNode",{in:"blur"}),e.jsx("feMergeNode",{in:"SourceGraphic"})]})]})]}),e.jsx("rect",{x:"0",y:"0",width:"520",height:"240",fill:"url(#sky)"}),e.jsx("rect",{x:"5",y:"40",width:"36",height:"80",rx:"2",fill:K,opacity:"0.18"}),e.jsx("rect",{x:"12",y:"48",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.15"}),e.jsx("rect",{x:"22",y:"48",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.12"}),e.jsx("rect",{x:"12",y:"62",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.1"}),e.jsx("rect",{x:"46",y:"55",width:"28",height:"65",rx:"2",fill:K,opacity:"0.15"}),e.jsx("rect",{x:"52",y:"62",width:"6",height:"8",rx:"1",fill:ce,opacity:"0.12"}),e.jsx("rect",{x:"80",y:"28",width:"32",height:"92",rx:"2",fill:K,opacity:"0.2"}),e.jsx("rect",{x:"86",y:"36",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.15"}),e.jsx("rect",{x:"98",y:"36",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.12"}),e.jsx("rect",{x:"86",y:"52",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.1"}),e.jsx("rect",{x:"98",y:"52",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.13"}),e.jsx("rect",{x:"410",y:"42",width:"30",height:"78",rx:"2",fill:K,opacity:"0.18"}),e.jsx("rect",{x:"416",y:"50",width:"7",height:"9",rx:"1",fill:ce,opacity:"0.12"}),e.jsx("rect",{x:"427",y:"50",width:"7",height:"9",rx:"1",fill:ce,opacity:"0.1"}),e.jsx("rect",{x:"446",y:"30",width:"38",height:"90",rx:"2",fill:K,opacity:"0.22"}),e.jsx("rect",{x:"452",y:"38",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.15"}),e.jsx("rect",{x:"464",y:"38",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.12"}),e.jsx("rect",{x:"452",y:"54",width:"8",height:"10",rx:"1",fill:ce,opacity:"0.1"}),e.jsx("rect",{x:"490",y:"58",width:"24",height:"62",rx:"2",fill:K,opacity:"0.15"}),e.jsxs(Yx,{children:[e.jsx("rect",{x:"0",y:"68",width:"160",height:"38",rx:"10",fill:"url(#trainBody)"}),e.jsx("rect",{x:"0",y:"68",width:"160",height:"6",rx:"3",fill:fe,opacity:"0.4"}),[0,1,2,3,4,5].map(n=>e.jsx("rect",{x:12+n*26,y:"78",width:"18",height:"18",rx:"3",fill:p.goldLight,opacity:"0.5"},n)),e.jsx("rect",{x:"0",y:"100",width:"160",height:"4",rx:"2",fill:K,opacity:"0.3"})]}),e.jsx("path",{d:"M100 82 Q140 48, 260 42 Q380 48, 420 82",fill:"url(#canopy)"}),e.jsx("path",{d:"M100 82 Q140 48, 260 42 Q380 48, 420 82",stroke:K,strokeWidth:"3",fill:"none",opacity:"0.5"}),e.jsx("path",{d:"M105 82 Q145 52, 260 46 Q375 52, 415 82",stroke:ce,strokeWidth:"1",fill:"none",opacity:"0.3"}),e.jsx("rect",{x:"128",y:"78",width:"10",height:"72",rx:"2",fill:"url(#pillar)"}),e.jsx("rect",{x:"254",y:"60",width:"12",height:"90",rx:"2",fill:"url(#pillar)"}),e.jsx("rect",{x:"382",y:"78",width:"10",height:"72",rx:"2",fill:"url(#pillar)"}),e.jsx("rect",{x:"90",y:"148",width:"340",height:"14",rx:"4",fill:"url(#platform)"}),e.jsx("rect",{x:"95",y:"162",width:"330",height:"3",rx:"1",fill:K,opacity:"0.15"}),e.jsx("rect",{x:"90",y:"148",width:"340",height:"3",rx:"1",fill:fe,opacity:"0.3"}),e.jsx("rect",{x:"140",y:"162",width:"12",height:"56",rx:"2",fill:"url(#pillar)"}),e.jsx("rect",{x:"254",y:"162",width:"14",height:"56",rx:"2",fill:"url(#pillar)"}),e.jsx("rect",{x:"368",y:"162",width:"12",height:"56",rx:"2",fill:"url(#pillar)"}),e.jsx("line",{x1:"100",y1:"132",x2:"420",y2:"132",stroke:K,strokeWidth:"1.5",opacity:"0.25"}),[0,1,2,3,4,5,6,7].map(n=>e.jsx("line",{x1:120+n*38,y1:"132",x2:120+n*38,y2:"148",stroke:K,strokeWidth:"1",opacity:"0.2"},`r${n}`)),e.jsx("rect",{x:"200",y:"46",width:"120",height:"28",rx:"5",fill:p.card,opacity:"0.55"}),e.jsx("rect",{x:"200",y:"46",width:"120",height:"28",rx:"5",stroke:fe,strokeWidth:"1.5",fill:"none",opacity:"0.4"}),e.jsx("text",{x:"260",y:"65",textAnchor:"middle",fontFamily:"sans-serif",fontSize:"13",fontWeight:"700",letterSpacing:"3",fill:Le,opacity:"0.7",children:"MG ROAD"}),e.jsx("rect",{x:"0",y:"218",width:"520",height:"22",rx:"0",fill:K,opacity:"0.08"}),e.jsx("line",{x1:"0",y1:"218",x2:"520",y2:"218",stroke:K,strokeWidth:"1",opacity:"0.2"}),e.jsxs("g",{transform:"translate(195, 78)",children:[e.jsx("ellipse",{cx:"0",cy:"70",rx:"12",ry:"3",fill:K,opacity:"0.18"}),e.jsx("circle",{cx:"0",cy:"0",r:"9",fill:Le}),e.jsx("path",{d:"M-8,-5 Q-9,-10 -3,-12 Q3,-13 8,-9 Q10,-5 8,-3",fill:Le,opacity:"0.8"}),e.jsx("rect",{x:"-3",y:"8",width:"6",height:"6",rx:"1",fill:Le}),e.jsx("path",{d:"M-14,14 Q-15,36 -10,48 L10,48 Q15,36 14,14 Z",fill:Le,opacity:"0.9"}),e.jsx("path",{d:"M-14,16 Q-20,30 -16,42",stroke:Le,strokeWidth:"4.5",strokeLinecap:"round",fill:"none"}),e.jsx("path",{d:"M14,16 Q18,28 17,38",stroke:Le,strokeWidth:"4.5",strokeLinecap:"round",fill:"none"}),e.jsx("path",{d:"M-6,48 L-8,70",stroke:Le,strokeWidth:"5.5",strokeLinecap:"round"}),e.jsx("path",{d:"M6,48 L7,70",stroke:Le,strokeWidth:"5.5",strokeLinecap:"round"})]}),e.jsx(Wx,{children:e.jsx(zx,{children:e.jsxs("g",{transform:"translate(400, 98)",children:[e.jsx("ellipse",{cx:"0",cy:"50",rx:"9",ry:"3",fill:K,opacity:"0.15"}),e.jsxs(Bx,{children:[e.jsx("path",{d:"M-5,-6 Q-8,-10 -4,-12 Q2,-13 6,-10 Q8,-6 7,-3",fill:fe}),e.jsx("path",{d:"M5,-4 Q10,0 12,10 Q11,18 8,13 Q7,7 5,2",fill:fe,opacity:"0.65"}),e.jsx("path",{d:"M7,-3 Q13,3 15,14 Q13,20 10,11",fill:fe,opacity:"0.4"})]}),e.jsx("circle",{cx:"0",cy:"0",r:"7.5",fill:fe}),e.jsx("rect",{x:"-1.5",y:"7",width:"3",height:"3",rx:"1",fill:fe}),e.jsx("path",{d:"M-8,10 Q-10,18 -8,26 L-3,31 L3,31 L8,26 Q10,18 8,10 Z",fill:fe,opacity:"0.85"}),e.jsx("path",{d:"M-3,29 Q-5,37 -12,50 L12,50 Q5,37 3,29 Z",fill:fe,opacity:"0.65"}),e.jsx(Rx,{children:e.jsx("path",{d:"M-8,12 Q-13,20 -11,28",stroke:fe,strokeWidth:"3.5",strokeLinecap:"round",fill:"none"})}),e.jsx(Hx,{children:e.jsx("path",{d:"M8,12 Q12,20 10,26",stroke:fe,strokeWidth:"3.5",strokeLinecap:"round",fill:"none"})})]})})})]})}),Vx=M`
  0% { background-position: -200% center; }
  100% { background-position: 200% center; }
`,Qx=M`
  0%, 100% { opacity: 0.4; transform: scale(1); }
...
`,Gu=o.p`
  ...
  line-height: 1.7;
  max-width: 420px;
`,Vu=({onComplete:t})=>{const[n,a]=h.useState(0),[r,i]=h.useState(null),[s,l]=h.useState(0),[d,f]=h.useState(!1),[c,x]=h.useState(!1),g=zt[n],u=r===(g==null?void 0:g.correctIndex),m=h.useCallback(b=>{r===null&&(i(b),b===g.correctIndex&&(l(k=>k+1),x(!0),setTimeout(()=>x(!1),1800)),setTimeout(()=>{n<zt.length-1?(a(k=>k+1),i(null)):f(!0)},2600))},[r,n,g]),v=b=>r===null?"idle":b===g.correctIndex?"correct":b===r?"wrong":"dimmed",w=()=>{const b=s/zt.length;return b===1?dn.perfect:b>=.7?dn.great:b>=.4?dn.good:dn.any};return e.jsxs(e.Fragment,{children:[c&&e.jsx(Ae,{mode:"burst"}),e.jsx(Mu,{children:e.jsx(Z,{mode:"wait",children:d?e.jsxs(Ru,{initial:{opacity:0,scale:.92},animate:{opacity:1,scale:1},transition:{duration:.8,ease:B.cinematic},children:[e.jsxs(Hu,{children:[s,"/",zt.length]}),e.jsx(Yu,{children:"Your Score"}),e.jsx(Gt,{children:e.jsx(ot,{})}),e.jsx(Gu,{children:w()}),e.jsx(Tx,{onClick:t,initial:{opacity:0},animate:{opacity:1},transition:{delay:1.5,duration:.8},whileTap:{scale:.97},children:"Take me deeper..."})]},"score"):e.jsxs(y.div,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"},initial:{opacity:0,y:30},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.55,ease:B.gentle},children:[e.jsx(Lu,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.6},children:"Do you know us?"}),e.jsx(Gt,{children:e.jsx(ot,{})}),e.jsx(Ou,{children:zt.map((b,k)=>e.jsx(Pu,{$active:k===n,$done:k<n},k))}),e.jsxs(_u,{children:[e.jsxs(Fu,{children:[e.jsx(Eu,{children:g.question}),e.jsx(Nu,{children:g.options.map((b,k)=>e.jsx(Wu,{$state:v(k),onClick:()=>m(k),whileTap:r===null?{scale:.98}:void 0,children:b},k))})]}),e.jsx(Z,{children:r!==null&&e.jsxs(zu,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.5,delay:.2},children:[e.jsx(Iu,{correct:u}),e.jsx(Bu,{children:u?g.correctReaction:g.wrongReaction})]})})]})]},n)})})]})};o.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
...
I will choose you,
every single day.`,style:"dramatic"},{text:"Forever starts now.",style:"finale"}],Qu="Yours, always and after",Uu=M`
...
`,qh=o(y.p)`
  ...
  max-width: 400px;
  line-height: 1.6;
`,Kh=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"})}),Xh=({onComplete:t})=>{const[n,a]=h.useState(0),[r,i]=h.useState(!1);return h.useEffect(()=>{const s=t,l=[setTimeout(()=>a(1),800),setTimeout(()=>{a(2),i(!0),setTimeout(()=>i(!1),2e3)},2e3),setTimeout(()=>a(3),3200),setTimeout(()=>a(4),4800),setTimeout(()=>s(),8e3)];return()=>l.forEach(clearTimeout)},[]),e.jsxs(Wh,{children:[e.jsx(Ae,{mode:"ambient",density:20}),r&&e.jsx(Ae,{mode:"burst",density:50}),e.jsxs(zh,{children:[e.jsxs(Rh,{children:[e.jsx(Hh,{initial:{opacity:0,x:-30},animate:{opacity:n>=1?1:0,x:n>=1?0:-30},transition:{duration:.8,ease:B.cinematic},children:"I"}),e.jsx(Yh,{initial:{opacity:0,scale:.3},animate:{opacity:n>=2?1:0,scale:n>=2?1:.3},transition:{type:"spring",stiffness:100,damping:12},children:"Love"}),e.jsx(Gh,{initial:{opacity:0,x:30},animate:{opacity:n>=3?1:0,x:n>=3?0:30},transition:{duration:.8,ease:B.cinematic},children:"You"})]}),e.jsx(Vh,{initial:{opacity:0,scale:0},animate:{opacity:n>=3?1:0,scale:n>=3?1:0},transition:{type:"spring",stiffness:200,damping:12,delay:n>=3?.3:0},children:e.jsx(Uh,{children:e.jsx(Kh,{})})}),e.jsxs(qh,{initial:{opacity:0,y:12},animate:{opacity:n>=4?1:0,y:n>=4?0:12},transition:{duration:1,ease:B.gentle},children:["More than words could ever say.",e.jsx("br",{}),"More than twelve years could ever show."]})]})]})},Jh=o.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
...
`,vf=[{x:"6%",s:9,d:7,dl:0,c:Be},{x:"16%",s:7,d:9,dl:1.5,c:Pe},{x:"28%",s:10,d:6,dl:.5,c:Be},{x:"40%",s:7,d:8,dl:2,c:ie},{x:"52%",s:9,d:7,dl:1,c:Be},{x:"62%",s:6,d:10,dl:3,c:Pe},{x:"74%",s:8,d:6.5,dl:.8,c:Be},{x:"84%",s:7,d:8,dl:2.5,c:ie},{x:"92%",s:9,d:7,dl:1.2,c:Be},{x:"48%",s:5,d:9,dl:4,c:Pe},{x:"20%",s:8,d:7.5,dl:3.5,c:ie},{x:"70%",s:6,d:8.5,dl:.3,c:Be}],bf=o.div`
  ...
  pointer-events: none;
  svg { width: 100%; height: 100%; }
`,jf=()=>e.jsx("svg",{viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"})}),wf=M`
  0% { background-position: -200% center; }
  100% { background-position: 200% center; }
`,kf=M`
  from { transform: scaleX(0); }
